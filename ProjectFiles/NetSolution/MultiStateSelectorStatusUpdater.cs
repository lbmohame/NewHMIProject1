...
public class MultiStateSelectorStatusUpdater : BaseNetLogic
{
    public override void Start()
    {
        ...
        circularHandle = Owner.Get("CircularHandle") as Image;
        if (circularHandle == null)
            throw new CoreConfigurationException("CircularHandle cannot be null");

        // The width of the circular handle is set to Stretch to update its dimensions in FTOptixStudio editor.
    ...
    private StyleSheet GetStyleSheet()
    {
        ...
        return InformationModel.Get<StyleSheet>(stylesheetNodeId);
    }
